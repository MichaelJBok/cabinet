                ...
                <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:3}}>
                  ...
                  <div style={{display:"flex",flexDirection:"column",alignItems:"flex-end",gap:5,flexShrink:0}}>
                    ...
                    <div style={{display:"flex",gap:5,alignItems:"center"}}>
                      <button onClick={() => openVariant(activeRecipe)} style={{padding:"0 9px",height:24,borderRadius:8,border:"1px solid rgba(100,200,255,0.4)",background:"rgba(100,200,255,0.08)",color:t.variantColor,cursor:"pointer",fontSize:10,fontFamily:"inherit",whiteSpace:"nowrap",lineHeight:"normal"}}>Variant</button>
                      <button onClick={() => openEdit(activeRecipe)} style={{padding:"0 9px",height:24,borderRadius:8,border:"1px solid rgba(255,200,100,0.4)",background:"rgba(255,215,0,0.1)",color:t.accent,cursor:"pointer",fontSize:10,fontFamily:"inherit",whiteSpace:"nowrap"}}>Edit</button>
                      <button onClick={() => deleteRecipe(activeRecipe.id)} style={{padding:"0 9px",height:24,borderRadius:8,border:"1px solid "+t.dangerBorder,background:"rgba(255,80,80,0.1)",color:t.dangerColor,cursor:"pointer",fontSize:10,fontFamily:"inherit",whiteSpace:"nowrap"}}>Delete</button>
                    </div>
                  </div>
                </div>
